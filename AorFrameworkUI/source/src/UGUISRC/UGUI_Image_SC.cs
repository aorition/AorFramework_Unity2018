...
//    [AddComponentMenu("UI/Image", 11)]
    public class UGUI_Image_SC : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        public enum Type
        {
            Simple,
        ...
        public Sprite sprite { get { return m_Sprite; } set { if (UGUI_SetPropertyUtility_SC.SetClass(ref m_Sprite, value)) SetAllDirty(); } }

        [NonSerialized]
        private Sprite m_OverrideSprite;
        public Sprite overrideSprite { get { return activeSprite; } set { if (UGUI_SetPropertyUtility_SC.SetClass(ref m_OverrideSprite, value)) SetAllDirty(); } }
        ...
        public Type type { get { return m_Type; } set { if (UGUI_SetPropertyUtility_SC.SetStruct(ref m_Type, value)) SetVerticesDirty(); } }

        [SerializeField] private bool m_PreserveAspect = false;
        public bool preserveAspect { get { return m_PreserveAspect; } set { if (UGUI_SetPropertyUtility_SC.SetStruct(ref m_PreserveAspect, value)) SetVerticesDirty(); } }

        [SerializeField] private bool m_FillCenter = true;
        public bool fillCenter { get { return m_FillCenter; } set { if (UGUI_SetPropertyUtility_SC.SetStruct(ref m_FillCenter, value)) SetVerticesDirty(); } }

        /// Filling method for filled sprites.
        [SerializeField] private FillMethod m_FillMethod = FillMethod.Radial360;
        public FillMethod fillMethod { get { return m_FillMethod; } set { if (UGUI_SetPropertyUtility_SC.SetStruct(ref m_FillMethod, value)) { SetVerticesDirty(); m_FillOrigin = 0; } } }
        ...
        public float fillAmount { get { return m_FillAmount; } set { if (UGUI_SetPropertyUtility_SC.SetStruct(ref m_FillAmount, Mathf.Clamp01(value))) SetVerticesDirty(); } }

        /// Whether the Image should be filled clockwise (true) or counter-clockwise (false).
        [SerializeField] private bool m_FillClockwise = true;
        public bool fillClockwise { get { return m_FillClockwise; } set { if (UGUI_SetPropertyUtility_SC.SetStruct(ref m_FillClockwise, value)) SetVerticesDirty(); } }
        ...
        public int fillOrigin { get { return m_FillOrigin; } set { if (UGUI_SetPropertyUtility_SC.SetStruct(ref m_FillOrigin, value)) SetVerticesDirty(); } }
