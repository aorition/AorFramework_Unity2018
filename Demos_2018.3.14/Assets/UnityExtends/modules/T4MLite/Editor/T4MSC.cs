...
namespace T4MLite
{
    ...
    public class T4MSC : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            //        MenuIcon[0] = new GUIContent(AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Icons/conv.png", typeof(Texture2D)) as Texture);
            //        MenuIcon[1] = new GUIContent(AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Icons/optimize.png", typeof(Texture2D)) as Texture);
            //        MenuIcon[2] = new GUIContent(AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Icons/myt4m.png", typeof(Texture2D)) as Texture);
            //        MenuIcon[3] = new GUIContent(AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Icons/paint.png", typeof(Texture2D)) as Texture);
            //        MenuIcon[4] = new GUIContent(AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Icons/plant.png", typeof(Texture2D)) as Texture);
            //        MenuIcon[5] = new GUIContent(AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Icons/lod.png", typeof(Texture2D)) as Texture);
            //        MenuIcon[6] = new GUIContent(AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Icons/bill.png", typeof(Texture2D)) as Texture);
            ...
            GUILayout.Label(
                AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/T4MBAN.jpg", typeof(Texture2D)) as Texture2D,
                GUILayout.Width(24), GUILayout.Height(582));
            GUILayout.EndArea();
            GUILayout.BeginArea(new Rect(25, 0, 363, 20));
            GUILayout.Label(AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/logo.png", typeof(Texture)) as Texture);
            GUILayout.EndArea();
            ...
            GUILayout.Label(
                AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/separator.png", typeof(Texture)) as Texture);
...
#if UNITY_5
                            ditorUtility.SetSelectedWireframeHidden(rendererPart[i], true);
#elif UNITY_2018
            ...
            else
            {
                ...
                GUILayout.FlexibleSpace();
                GUILayout.Label(
                    AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/waiting.png", typeof(Texture)) as Texture);
                GUILayout.FlexibleSpace();
                GUILayout.EndHorizontal();
                GUILayout.FlexibleSpace();
...
#elif UNITY_2018
                    PrefabUtility.RevertObjectOverride(CurrentSelect.gameObject, InteractionMode.AutomatedAction); //Todo 代码迁移问题？ InteractionMode.AutomatedAction 是否是正确的参数？
#endif
                    AssetName = "";
                }
                GUILayout.FlexibleSpace();
        ...
        void CreatePrefabBB()
        {
            if (!System.IO.Directory.Exists(T4MPathDef.T4MPrefabFolder + "BillBObjects/"))
            {
                System.IO.Directory.CreateDirectory(T4MPathDef.T4MPrefabFolder + "BillBObjects/");
            }
            if (!System.IO.Directory.Exists(T4MPathDef.T4MPrefabFolder + "BillBObjects/Material/"))
            {
                System.IO.Directory.CreateDirectory(T4MPathDef.T4MPrefabFolder + "BillBObjects/Material/");
            }
            ...
            else
            {
                GameObject Temp =
                    (GameObject)
                        AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "MeshBillb/Billboard.fbx", typeof(GameObject));
            ...
            do
            {
                ...
                if (!System.IO.File.Exists(T4MPathDef.T4MPrefabFolder + "BillBObjects/" + PrefabName + ".prefab"))
                {
                    if (ShaderLOD1S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD1Material,
                            T4MPathDef.T4MPrefabFolder + "BillBObjects/Material/" + PrefabName + ".mat");
#if UNITY_5
                    BasePrefab = PrefabUtility.CreateEmptyPrefab(T4MPathDef.T4MPrefabFolder + "BillBObjects/" + PrefabName + ".prefab");
                    PrefabUtility.ReplacePrefab(LOD1Temp, BasePrefab);
#elif UNITY_2018
                    PrefabUtility.SaveAsPrefabAsset(LOD1Temp, T4MPathDef.T4MPrefabFolder + "BillBObjects/" + PrefabName + ".prefab");
#endif
                    ExportSuccess = true;
                }
                else if (!System.IO.File.Exists(T4MPathDef.T4MPrefabFolder + "BillBObjects/" + Next + ".prefab"))
                {
                    if (ShaderLOD1S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD1Material, T4MPathDef.T4MPrefabFolder + "BillBObjects/Material/" + Next + ".mat");
#if UNITY_5
                    BasePrefab = PrefabUtility.CreateEmptyPrefab(T4MPathDef.T4MPrefabFolder + "BillBObjects/" + Next + ".prefab");
                    PrefabUtility.ReplacePrefab(LOD1Temp, BasePrefab);
#elif UNITY_2018
                    PrefabUtility.SaveAsPrefabAsset(LOD1Temp, T4MPathDef.T4MPrefabFolder + "BillBObjects/" + Next + ".prefab");
#endif
                    ExportSuccess = true;
                }
                num++;
...
//                Swap = (Texture)AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/on.png", typeof(Texture));
//            }
//            else
//            {
//                buttonBill = "ACTIVATE";
//                Swap = (Texture)AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/off.png", typeof(Texture));
//            }
//
//
...
//        }
        ...
        void Planting()
        {
            if (CurrentSelect.GetComponent<T4MObjSC>())
            {
                    ...
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Control"))
                {
                    ...
                    if (
                        GUILayout.Button(
                            (Texture)AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/down.png", typeof(Texture)),
                            GUILayout.Width(53)))
                    {
                        if (AddObject)
            ...
            if (CurrentSelect.GetComponent<T4MObjSC>())
            {
                    ...
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Control"))
                {
                    ...
                    if (intialized)
                    {
                        ...
                        GUILayout.FlexibleSpace();
                        GUILayout.Label(
                            AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/brushes.jpg", typeof(Texture)) as
                                Texture, "label");
        ...
        void IniBrush()
        {
            ...
            do
            {
                BrushesTL =
                    (Texture)
                        AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Brushes/Brush" + BrushNum + ".png",
                            typeof(Texture));
                if (BrushesTL)
                {
        ...
        void CreatePrefab()
        {
            if (!System.IO.Directory.Exists(T4MPathDef.T4MPrefabFolder + "LODObjects/"))
            {
                System.IO.Directory.CreateDirectory(T4MPathDef.T4MPrefabFolder + "LODObjects/");
            }
            if (!System.IO.Directory.Exists(T4MPathDef.T4MPrefabFolder + "LODObjects/Material/"))
            {
                System.IO.Directory.CreateDirectory(T4MPathDef.T4MPrefabFolder + "LODObjects/Material/");
            }
            AssetDatabase.Refresh();
            ...
            do
            {
                ...
                if (!System.IO.File.Exists(T4MPathDef.T4MPrefabFolder + "LODObjects/" + PrefabName + "_LOD.prefab"))
                {

                    if (ShaderLOD1S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD1Material,
                            T4MPathDef.T4MPrefabFolder + "LODObjects/Material/" + PrefabName + "LOD1.mat");
                    if (ShaderLOD2S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD2Material,
                            T4MPathDef.T4MPrefabFolder + "LODObjects/Material/" + PrefabName + "LOD2.mat");
                    if (ShaderLOD3S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD3Material, T4MPathDef.T4MPrefabFolder + "LODObjects/Material/" + PrefabName + "LOD3.mat");
#if UNITY_5
                    BasePrefab = PrefabUtility.CreateEmptyPrefab(T4MPathDef.T4MPrefabFolder + "LODObjects/" + PrefabName + ".prefab");
                    PrefabUtility.ReplacePrefab(LOD1Temp, BasePrefab);
#elif UNITY_2018
                    PrefabUtility.SaveAsPrefabAsset(LOD1Temp, T4MPathDef.T4MPrefabFolder + "LODObjects/" + PrefabName + ".prefab");
#endif
                    ExportSuccess = true;
                }
                else if (!System.IO.File.Exists(T4MPathDef.T4MPrefabFolder + "LODObjects/" + Next + "_LOD.prefab"))
                {

                    if (ShaderLOD1S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD1Material,
                            T4MPathDef.T4MPrefabFolder + "LODObjects/Material/" + Next + "LOD1.mat");
                    if (ShaderLOD2S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD2Material,
                            T4MPathDef.T4MPrefabFolder + "LODObjects/Material/" + Next + "LOD2.mat");
                    if (ShaderLOD3S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD3Material, T4MPathDef.T4MPrefabFolder + "LODObjects/Material/" + Next + "LOD3.mat");
#if UNITY_5
                    BasePrefab = PrefabUtility.CreateEmptyPrefab(T4MPathDef.T4MPrefabFolder + "LODObjects/" + Next + ".prefab");
                    PrefabUtility.ReplacePrefab(LOD1Temp, BasePrefab);
#elif UNITY_2018
                    PrefabUtility.SaveAsPrefabAsset(LOD1Temp, T4MPathDef.T4MPrefabFolder + "LODObjects/" + Next + ".prefab");
#endif
                    ExportSuccess = true;
                }
                num++;
...
#region modify 18/3/7
                    ...
                    if (CurrentSelect.GetComponent<Terrain>())
                    {
                        ...
                        if (X * Y <= 15000)
                            GUILayout.Label(
                                AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/ok.png", typeof(Texture)) as
                                    Texture);
                        else if (X * Y > 15000 && X * Y < 30000)
                            GUILayout.Label(
                                AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/avoid.png", typeof(Texture)) as
                                    Texture);
                        else if (X * Y >= 30000)
                            GUILayout.Label(
                                AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/ko.png", typeof(Texture)) as
                                    Texture);
                        GUILayout.EndHorizontal();
                        GUILayout.BeginHorizontal();
                        ...
                        GUILayout.Label(
                            AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/ok.png", typeof(Texture)) as Texture);
                        GUILayout.EndHorizontal();
                        GUILayout.BeginHorizontal();
            ...
            else
            {
                ...
                if (GUILayout.Button("Modify Options and Start a New Conversion"))
                {
                    ...
                    AssetDatabase.DeleteAsset(T4MPathDef.T4MPrefabFolder + "Terrains/Meshes/" + FinalExpName + ".obj");
                    AssetDatabase.DeleteAsset(T4MPathDef.T4MPrefabFolder + "Terrains/" + FinalExpName + ".prefab");
                    AssetDatabase.DeleteAsset(T4MPathDef.T4MPrefabFolder + "Terrains/Texture/" + FinalExpName + ".png");
                    AssetDatabase.DeleteAsset(T4MPathDef.T4MPrefabFolder + "Terrains/Material/" + FinalExpName + ".mat");
                    ...
                    case 1:
                            ...
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Control"))
                        {
                            ...
                            if (
                                GUILayout.Button(
                                    (Texture)
                                        AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/up.png", typeof(Texture)),
                                    GUILayout.Width(53)))
                            {
#if UNITY_5
                            ...
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat2"))
                                if (
                                    GUILayout.Button(
                                        (Texture)
                                            AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/up.png",
        ...
        void ClassicMat()
        {
            ...
            if (selProcedural == 0)
            {
                if (Layer1)
                {
                    ...
                    GUILayout.BeginHorizontal("Box");
                    GUILayout.Label(
                        (Texture)AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/TDiff.jpg", typeof(Texture)));
                    Layer1 =
                    ...
                    {
                        GUILayout.Label(
                            (Texture)AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/TBump.jpg", typeof(Texture)));
                        Layer1Bump =
                ...
                Shader.Find("T4MShaders/ShaderModel1/T4M 2 Textures ManualAdd CustoLM 1DC"))
            {
                ...
                GUILayout.BeginHorizontal("Box");
                GUILayout.Label(
                    (Texture)AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MEditorFolder + "Img/TLM.jpg", typeof(Texture)));
                LMMan =
        ...
        void MyT4MApplyChange()
        {
            ...
            else if (ShaderModel == SM.ShaderModel2)
            {
                ...
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_2_Textures_Toon)
                {
                    ...
                    Cubemap ToonShade =
                        (Cubemap)
                            AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MFolder + "Shaders/Sources/toony lighting.psd",
                                typeof(Cubemap));
            ...
            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Control2"))
            {
                ...
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Control") != null)
                {
                    Control2 =
                        (Texture)
                            AssetDatabase.LoadAssetAtPath(
                                T4MPathDef.T4MPrefabFolder + "Terrains/Texture/" +
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                    ...
                    Control2 =
                        (Texture)
                            AssetDatabase.LoadAssetAtPath(
                                T4MPathDef.T4MPrefabFolder + "Terrains/Texture/" + CurrentSelect.gameObject.name + "C2.png",
                                typeof(Texture));
...
//                CurrentSelect.GetComponent<T4MObjSC>().PlayerCamera = PlayerCam;
        ...
        void CreateControl2Text()
        {
            ...
            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Control") != null)
            {
                path = T4MPathDef.T4MPrefabFolder + "Terrains/Texture/" +
                       CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Control").name +
                       "C2.png";

            }
            else path = T4MPathDef.T4MPrefabFolder + "Terrains/Texture/" + CurrentSelect.gameObject.name + "C2.png";
        ...
        void ConvertUTerrain()
        {
            ...
            if (!System.IO.Directory.Exists(T4MPathDef.T4MPrefabFolder + "Terrains/"))
            {
                System.IO.Directory.CreateDirectory(T4MPathDef.T4MPrefabFolder + "Terrains/");
            }
            if (!System.IO.Directory.Exists(T4MPathDef.T4MPrefabFolder + "Terrains/Material/"))
            {
                System.IO.Directory.CreateDirectory(T4MPathDef.T4MPrefabFolder + "Terrains/Material/");
            }
            if (!System.IO.Directory.Exists(T4MPathDef.T4MPrefabFolder + "Terrains/Texture/"))
            {
                System.IO.Directory.CreateDirectory(T4MPathDef.T4MPrefabFolder + "Terrains/Texture/");
            }
            if (!System.IO.Directory.Exists(T4MPathDef.T4MPrefabFolder + "Terrains/Meshes/"))
            {
                System.IO.Directory.CreateDirectory(T4MPathDef.T4MPrefabFolder + "Terrains/Meshes/");
            }
            AssetDatabase.Refresh();
            ...
            do
            {
                ...
                if (!System.IO.File.Exists(T4MPathDef.T4MPrefabFolder + "Terrains/" + terrainName + ".prefab"))
                {
                    FinalExpName = terrainName;
                    ExportNameSuccess = true;
                }
                else if (!System.IO.File.Exists(T4MPathDef.T4MPrefabFolder + "Terrains/" + Next + ".prefab"))
                {
                    FinalExpName = Next;
                    ExportNameSuccess = true;
                }
            ...
            //StreamWriter  sw = new StreamWriter(T4MPathDef.T4MPrefabFolder+"Terrains/Meshes/"+FinalExpName+".obj");
            ...
            string path = T4MPathDef.T4MPrefabFolder + "Terrains/Texture/" + FinalExpName + ".png";
            ...
            AssetDatabase.CreateAsset(Tmaterial, T4MPathDef.T4MPrefabFolder + "Terrains/Material/" + FinalExpName + ".mat");
            AssetDatabase.ImportAsset(T4MPathDef.T4MPrefabFolder + "Terrains/Material/" + FinalExpName + ".mat",
...
#elif UNITY_2018
                TerrainLayer[] texts = CurrentSelect.GetComponent<Terrain>().terrainData.terrainLayers;
                for (int e = 0; e < texts.Length; e++)
                {
                    if (e < 4)
                    {
            ...
            FileUtil.CopyFileOrDirectory(FinalExpName + ".obj",
                T4MPathDef.T4MPrefabFolder + "Terrains/Meshes/" + FinalExpName + ".obj");
            FileUtil.DeleteFileOrDirectory(FinalExpName + ".obj");



            //Force Update
            AssetDatabase.ImportAsset(T4MPathDef.T4MPrefabFolder + "Terrains/Meshes/" + FinalExpName + ".obj",
                ImportAssetOptions.ForceUpdate);
            ...
            GameObject prefab =
                (GameObject)
                    AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MPrefabFolder + "Terrains/Meshes/" + FinalExpName + ".obj",
                        typeof(GameObject));
...
#if UNITY_5
            GameObject BasePrefab2 = PrefabUtility.CreatePrefab(T4MPathDef.T4MPrefabFolder + "Terrains/" + FinalExpName + ".prefab", Child);
#elif UNITY_2018
            GameObject BasePrefab2 = PrefabUtility.SaveAsPrefabAsset(Child, T4MPathDef.T4MPrefabFolder + "Terrains/" + FinalExpName + ".prefab");
#endif
            AssetDatabase.ImportAsset(T4MPathDef.T4MPrefabFolder + "Terrains/" + FinalExpName + ".prefab",
                ImportAssetOptions.ForceUpdate);
            ...
            AssetDatabase.DeleteAsset(T4MPathDef.T4MPrefabFolder + "Terrains/Meshes/Materials");
            terrainName = "";
            AssetDatabase.StartAssetEditing();
            //Modification des attribut du mesh avant de le pr茅fabriquer
            ModelImporter OBJI = ModelImporter.GetAtPath(T4MPathDef.T4MPrefabFolder + "Terrains/Meshes/" + FinalExpName + ".obj") as ModelImporter;
            OBJI.globalScale = 1;
#if UNITY_5
            ...
            //AssetDatabase.ImportAsset (T4MPathDef.T4MPrefabFolder+"Terrains/Meshes/"+FinalExpName+".obj", ImportAssetOptions.TryFastReimportFromMetaData);
            AssetDatabase.ImportAsset(T4MPathDef.T4MPrefabFolder + "Terrains/Meshes/" + FinalExpName + ".obj",
...
#elif UNITY_2018
            PrefabUtility.RevertObjectOverride(Child, InteractionMode.AutomatedAction); //Todo 代码迁移问题？ InteractionMode.AutomatedAction 是否是正确的参数？
#endif
        }
        ...
        void Obj2T4M()
        {
            ...
            do
            {
                ...
                if (!System.IO.File.Exists(T4MPathDef.T4MPrefabFolder + "Terrains/Material/" + terrainName + ".mat"))
                {
                    FinalExpName = terrainName;
                    ExportNameSuccess = true;
                }
                else if (!System.IO.File.Exists(T4MPathDef.T4MPrefabFolder + "Terrains/Material/" + Next + ".mat"))
                {
                    FinalExpName = Next;
                    ExportNameSuccess = true;
                }
            ...
            var path = T4MPathDef.T4MPrefabFolder + "Terrains/Texture/" + FinalExpName + ".png";
            ...
            //aorition hacked
            var path2 = T4MPathDef.T4MPrefabFolder + "Terrains/Texture/" + FinalExpName + "_oc.png";
            ...
            {
#if UNITY_5
                UnityEngine.Object BasePrefab = PrefabUtility.CreateEmptyPrefab(T4MPathDef.T4MPrefabFolder + "Terrains/" + FinalExpName + ".prefab");
                PrefabUtility.ReplacePrefab(CurrentSelect.gameObject, BasePrefab);
#elif UNITY_2018
                PrefabUtility.SaveAsPrefabAsset(CurrentSelect.gameObject, T4MPathDef.T4MPrefabFolder + "Terrains/" + FinalExpName + ".prefab");
#endif
                GameObject prefab = (GameObject)AssetDatabase.LoadAssetAtPath(T4MPathDef.T4MPrefabFolder + "Terrains/" + FinalExpName + ".prefab", typeof(GameObject));
