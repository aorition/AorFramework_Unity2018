...
namespace Framework.Editor.Utility
{
    ...
    {
        [MenuItem("AssetsManagedTools/Mesh/Mesh合并工具/MeshCombineInScene")]
        ...
        private static void restoreMeshCombineObjOriginal(Transform target, List<string> unActiveList, List<string> unMeshRenderEnableList, List<string> pldList)
        {
            ...
            if (unActiveList != null && unActiveList.Count > 0)
            {
                ...
                {
#if UNITY_2018
                    Transform t = target.Find(unActiveList[i]);
#elif UNITY_5
...
#if UNITY_2018
                    Transform t = target.Find(pldList[i]);
#elif UNITY_5
        ...
        [MenuItem("AssetsManagedTools/Mesh/Mesh合并工具/MeshCombineToAsset")]
        ...
        [MenuItem("AssetsManagedTools/Mesh/Mesh合并工具/MeshMergeInScene")]
        ...
        [MenuItem("AssetsManagedTools/Mesh/Mesh合并工具/MeshMergeToAsset")]
