...
public class AnimatorDebugerWindow : UnityEditor.EditorWindow
{
    [MenuItem("AssetsManagedTools/Animation/Animator 预览工具")]
    public static AnimatorDebugerWindow init()
    {
        AnimatorDebugerWindow w = EditorWindow.GetWindow<AnimatorDebugerWindow>();
        return w;
    }
