...
namespace Framework.Graphic
{
    ...
    public class GraphicsManager : ManagerBase
    {
        ...
        {
            return ManagerBase.CreateInstance<GraphicsManager>(ref _instance, parenTransform);
        }
        ...
        protected override void init()
        {
            ...
            if (!_mainCamera) _mainCamera = new GameObject().AddComponent<Camera>();
            ...
            _mainCamera.transform.SetParent(transform, false);
        ...
        public CamlensEffects Effect
        {
            get
            {
                if (CamlensEffects.Instance == null)
                {
                    return CamlensEffects.GetInstance(this);
                }
                return CamlensEffects.Instance;
            }
        }
