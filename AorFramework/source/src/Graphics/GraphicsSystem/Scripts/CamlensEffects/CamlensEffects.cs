...
{
    public class CamlensEffects
    {

        private static CamlensEffects _instance;
        public static CamlensEffects Instance
        {
            get { return _instance; }
        }

        public static CamlensEffects GetInstance(GraphicsManager manager)
        {
            if (_instance == null)
            {
                _instance = new CamlensEffects(manager);
            }
            return _instance;
        }
        ...
        private CamlensEffects(GraphicsManager manager)
        {
            _manager = manager;
        }
